...
public class DeviceConfigDeserializerTest {
    ...
    static SampleConfig testSampConfig = new SampleConfig("abcd", "testSample","test/parsing",
            Arrays.asList(new ItemNumConfig("tension", "tns", ItemType.Double, -1, 2, 1.0, NumGenerator.DEFAULT_DEV),
                    new ItemNumConfig("nuts", "nuts", ItemType.Long, 1, 100, 1.0, NumGenerator.DEFAULT_DEV),
    ...
    public void yamlTestWithKeyStrings() throws JsonProcessingException {
        ...
        ItemConfig ic1 = new ItemNumConfig("alpha", "alpha", ItemType.Double, -100, 100, 1.0, NumGenerator.DEFAULT_DEV);
        ItemConfig ic2 = new ItemNumConfig("beta", "beta", ItemType.Long, 0, 1000, 2.0, NumGenerator.DEFAULT_DEV);
        ...
        ItemConfig ic5 = new ItemNumConfig("epsilon", "epsl", ItemType.Double, -1, 10000, 3.0, NumGenerator.DEFAULT_DEV);
